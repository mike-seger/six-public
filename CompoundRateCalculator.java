...
public class CompoundRateCalculator {
	...
	public static class CompoundRate {
		...
		public String toString() {
			return String.format("{\"startDate\": \"%s\", \"endDate\": \"%s\", \"valueD4\": \"%s\", \"valueD6\": \"%s\", \"value\": \"%s\", \"valueR\": \"%s\"}\n",
				startDate, endDate, r4(value), r6(value), value, valueR);
		}
	}
	...
	public CompoundRate compoundRate(SortedMap<LocalDate, Rate> rateMap, LocalDate startDate, LocalDate endDate) {
		...
		while(date.isBefore(endDate)) {
			...
			debugFactor(weight, rate, factor, product);
		...
		return new CompoundRate(startDate, endDate, result, resultR);
	}

	private void debugFactor(BigDecimal weight, Rate rate, BigDecimal factor, BigDecimal product) {
